...
@section('content')
    ...
    <div class="comtainer mt-5" style=" font-family: 'Segoe UI', Arial, sans-serif;">
        <table class="table table-responsive table-bordered">
            ...
            <tbody>
                <tr>  
                    <th scope="row" style="line-height: 8rem; text-align: center">1</th>
                    <td style="line-height: 8rem;text-align: center">Jung Jaehyun</td>
                    <td style="line-height: 8rem;text-align: center"><center>
                        <a class="btn btn-outline-light" href='#' style="font-weight: 600; background-color:#F58814;color:white;border-radius:7px 7px 7px 7px;width:15rem;">PICK UP</button>
                        <a class="btn btn-danger" href='#' onclick="return confirm('Are you sure?')" style="font-weight: 600;color:white;border-radius:7px 7px 7px 7px;width:15rem;">DELETE</a>
                    </center></td>
                </tr>
            </tbody>
