    ...
    <div class="col d-flex justify-content-center" style="margin-bottom:20px;" >
      <div class="card card-block d-flex justify-content-center align-items-center" style="width: 400px; height:430px; border-radius: 25px; border-solid:1px; border-color:#D77409;">
        ...
        <div class="card-body">
          ...
          <p class="card-text" style="font-size:16px; font-family: Nunito; font-weight: 400; text-align: center;">Order Loak.in merupakan fitur utama dari Loak.in. Fitur ini berguna untuk memanggil tukang loak terdekat. Fitur ini bisa digunakan kapan saja dan dimana saja</p>
          <a href="{{ route('order.index') }}" class="btn btn-outline-light" style="background-color:#F58814;font-color:white;width:50%;border-radius:25px 25px 25px 25px; width: 182px; left: 336px; font-family: Nunito; margin-left: 100px">ORDER LOAK.IN</a>
        </div> 
      </div>
    </div> 
