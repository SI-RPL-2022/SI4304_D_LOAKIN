                ...
                <div class="col-lg-3 justify-content-center pt-5">
                    <form>
                            <div class="card" style="width: 15rem; margin-bottom:20px">
                                <img src="https://drive.google.com/uc?export=view&id=1I5-AgZSucUQHfvPUY5F4W95AhHOgmmbT" class="card-img-top" height="200px">
                                <div class="card-body">
                                    <a href="#" style="text-decoration: none; color: black;">
                                        <h5 class="card-title">Tas Bekas Dari Baju</h5>
                                    </a>
                                    <p class="card-text" style="color:red">Rp 10000</p>
