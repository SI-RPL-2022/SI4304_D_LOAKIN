        ...
        <div class="row gx-4">
          <div class="col-lg-2">
            <div class="avatar avatar-xl position-relative">
              <img src="" alt="profile_image" class="w-50 img-fluid border-radius-lg " style="margin-right: 0px">
            </div>
          </div>
            ...
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="mt-2">
                    <a href="#" class="btn btn-outline-light" style="background-color:#F58814;font-color:white;" type="submit" name="submit">
          ...
          <div class="card card-profile">
            ...
            <div class="card-body pt-0">
              ...
              <div class="text-center mt-4">
                ...
                <div>
                  <i class="ni education_hat mr-2"></i>Status Member | <b></b>
                </div>
              </div>
            </div>
          </div>
