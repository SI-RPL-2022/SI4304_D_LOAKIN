            ...
            <div style="border-style:solid; border-width:1px; border-color: #F58814;border-radius: 10px; padding:10px;">
                <div class="mt-2" style="margin-left: 30px;margin-right:40px">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="nama" value="{{$account->name}}" readonly style="border-width:0 0 1px 0;box-shadow:none" placeholder="Lucas">
                    </div>
                    <div class="mb-3">
                        <label for="notlp" class="form-label"><b>Nomor Telepon</b></label>
                        <input type="number" class="form-control" id="notlp" value="{{$account->telepon}}" readonly style="border-width:0 0 1px 0;box-shadow:none" placeholder="081232876816">
                    </div>
                    <div class="mb-3">
                        <label for="alamat" class="form-label"><b>Alamat</b></label>
                        <input type="text" class="form-control" id="alamat" name="alamat" style="border-width:0 0 1px 0;box-shadow:none" placeholder="Jalanin dulu yang ada">
                    </div>
                </div>
            </div>
