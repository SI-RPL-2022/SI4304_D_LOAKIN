<div class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
        ...
        <a class="navbar-brand m-0" href=" / " target="_blank">
            <center><img src="{{asset('logo.png')}}" class="navbar-brand-img h-100 " alt="main_logo"></center>
        </a>
        </div>
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
            <a class="nav-link " href="{{ route('orderadmin.index') }}">
                <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                <i class="ni ni-world-2 text-danger text-sm opacity-10"></i>
                </div>
                <span class="nav-link-text ms-1">Data Order Customer</span>
            </a>
            </li>
